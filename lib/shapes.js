...
class Circle extends Shapes {
    render() {
        ...
        return `<svg width="300" height="200">${circleElement}${textElement}</svg>`;
    }
}
...
class Triangle extends Shapes {
    render() {
        ...
        return `<svg width="300" height="200">${triangleElement}${textElement}</svg>`;
    }
}
...
class Square extends Shapes {
    render() {
        ...
        return `<svg width="300" height="200">${squareElement}${textElement}</svg>`;
    }
}
